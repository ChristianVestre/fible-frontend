...
})(["height:auto;width:98%;outline:0px solid transparent;word-wrap:break-word;padding:1%;border:", " 0.2vh;margin:", ";border-radius:2.5vh;display:flex;"], function (props) {
...
})(["font-weight:lighter;height:94%;width:90%;font-size:3vh;margin:0.2vh;padding:0.5vh;text-align:center;resize:none;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;align-self:center;border:0;display:flex;:focus{outline:none;caret-color:salmon;}"]);
...
//# sourceMappingURL=1.2f3994035b3e222170f5.hot-update.js.map